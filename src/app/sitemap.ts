...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    ...
    { url: `${BASE_URL}/timestamp-converter`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.9 },
    { url: `${BASE_URL}/cpf-cnpj-generator`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.9 },
  ];
}
